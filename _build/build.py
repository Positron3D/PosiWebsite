...
DISCORD = '<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M20.3 4.4A19.8 19.8 0 0015.4 3l-.2.4a18.3 18.3 0 015.5 2.8c-3.6-1.7-7.6-1.7-11.5 0A18.3 18.3 0 018.7 3.4L8.5 3a19.8 19.8 0 00-4.9 1.4C1 9.1.4 13.6.6 18.1A19.9 19.9 0 006.7 21l.4-.6c-.7-.3-1.4-.6-2-1l.5-.4c3.8 1.8 8 1.8 11.8 0l.5.4c-.6.4-1.3.7-2 1l.4.6a19.9 19.9 0 006.1-3c.3-5.3-.6-9.8-2.5-13.6zM8.9 15.3c-1.2 0-2.2-1.1-2.2-2.4s1-2.4 2.2-2.4 2.2 1.1 2.2 2.4-1 2.4-2.2 2.4zm6.2 0c-1.2 0-2.2-1.1-2.2-2.4s1-2.4 2.2-2.4 2.2 1.1 2.2 2.4-1 2.4-2.2 2.4z"/></svg>'
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="logos">
        ...
        <a class="logo-card" href="https://www.olli3d.com" target="_blank" rel="noopener"><div class="logo-card__chip"><img src="assets/img/partner-olli3d.png" alt="Olli3D"></div><h3>Olli3D</h3><span class="btn btn--sm btn--ghost">More Details</span></a>
      </div>
    </div>
  </section>
